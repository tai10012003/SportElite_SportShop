...
namespace WebService.Migrations
{
    ...
    [Migration("20260114085433_AddWishlistTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebService.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebService.Models.OrderStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebService.Models.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebService.Models.Order", b =>
                {
                    b.HasOne("WebService.Models.User", "NguoiDung")
                        .WithMany()
                        .HasForeignKey("MaNguoiDung")
                        .HasPrincipalKey("MaNguoiDung")
            ...
            modelBuilder.Entity("WebService.Models.OrderDetail", b =>
                {
                    b.HasOne("WebService.Models.Order", "DonHang")
